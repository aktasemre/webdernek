...
const CursesPage = () => {
  const curses = [
    ...
    },
    {
      ...
      "meaning": "Hem insanın yüzünün gülmemesini hem de evinin kapısının dertle dolu olmasını istemek anlamında kullanılır."
    },
    {
      "curse": "Kara kışta odunsuz, ocaksız kalasın",
      "meaning": "Isınma imkânından yoksun kalarak zorlu kış şartlarını yaşa şeklinde bir olumsuz dilektir."
    },
    {
      "curse": "Gözün doymadan gözün toprak doysun",
      "meaning": "Açgözlülükle ilişkilendirilir; kişi dünya nimetlerine doymadan ölsün anlamında kullanılır."
    },
    {
    ...
    },
    {
      ...
      "meaning": "Fiziksel olarak rahat ortam bulsa da iç huzurdan yoksun kalsın, rahat uyuyamasın dileğini anlatır."
    },
    {
    ...
    },
    {
      ...
      "meaning": "Evin kapansın, kimseye kapı açamaz hâle gel (misafir alamayasın) anlamında kullanılır."
    },
    {
      "curse": "Gafil avlansın, düşmanın senden önce duysun",
      "meaning": "Her işinde hazırlıksız kal, düşmanların senden önce haber alsın anlamında bedduadır."
    },
    {
    ...
    },
    {
      ...
      "meaning": "Devamlı çeşitli belalarla uğraş, evin zararlı hayvanlardan kurtulamasın anlamında kullanılır."
    },
    {
      "curse": "Uykudan uyan, uyanınca dertle uyan",
      "meaning": "Rahatın yalnızca uyku sırasında kalsın, uyanır uyanmaz belalara düş anlamında bir bedduadır."
    },
    {
    ...
    },
    {
      ...
      "meaning": "Hiçbir isteğine kavuşamayarak ölümü tek çare olarak görmek anlamında ağır bir bedduadır."
    },
    {
