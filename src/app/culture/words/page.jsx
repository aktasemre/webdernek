    ...
    <div className={styles.wordsPage}>
      <div className={styles.container}>
        ...
        <p className={styles.intro}>
          Köyümüzde kullanılan yerel kelimeleri ve anlamlarını burada bulabilirsiniz. Bu kelimeler,
          yöremizin kültürel zenginliğini yansıtmaktadır.
        </p>
        ...
        {filteredWords.length === 0 && (
          <p className={styles.noResults}>Aradığınız kelime bulunamadı.</p>
        )}
      </div>
    </div>
  );
