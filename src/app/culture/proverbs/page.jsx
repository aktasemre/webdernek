    ...
    <div className={styles.proverbsPage}>
      <div className={styles.container}>
        ...
        <p className={styles.intro}>
          Köyümüzde sıkça kullanılan atasözleri ve deyimler, atalarımızdan bize miras kalan bilgelik
          hazineleridir. Bu sözler, hayat tecrübelerini ve toplumsal değerleri yansıtır.
        </p>
        ...
        {filteredProverbs.length === 0 && (
          <p className={styles.noResults}>Aradığınız atasözü bulunamadı.</p>
        )}
      </div>
    </div>
  );
