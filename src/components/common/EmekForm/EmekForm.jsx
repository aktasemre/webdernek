  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="prose max-w-none text-gray-700">
        <p className="mb-4">Değerli Köylülerimiz,</p>
        <p className="mb-4">
          Bayburt Arslandede Köyü Yardımlaşma ve Dayanışma Derneği olarak, köyümüzün dayanışmasını
          güçlendirmek ve birbirimizi daha yakından tanımak amacıyla bir Meslek Envanteri Çalışması
          başlatıyoruz.
        </p>
        <p className="mb-6">
